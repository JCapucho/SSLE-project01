# /var/ossec/integrations/custom-urlhaus.py
...
def query_api(url):
  params = {'url': url}
  headers = {"Auth-Key": "<urlhaus API key>"}
  response = requests.post('https://urlhaus-api.abuse.ch/v1/url/', params, headers=headers)
